# Positional Argument Unpacking def shout_strings(*args):
# Keyword Argument Unpacking The syntax is very similar, but uses two asterisks (**)
...
#por algun motivo falla aunque esta igual que la solución
